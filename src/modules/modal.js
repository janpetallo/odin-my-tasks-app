    ...
    .addEventListener("submit", (event) => {
      ...
      if (todoName && todoDueDate && todoPriority) {
        ...
        const currentProjectName =
          document.querySelector(".current-selected").textContent; // get the current selected project
...
export function initializeEditModal(editIcon, todoItem, projects, ui) {
  editIcon.addEventListener("click", () => {
    ...
    editTodoModal.querySelector("#edit-todo-description").value =
      todoItem.description;
    editTodoModal.querySelector("#edit-todo-due-date").value = todoItem.dueDate;
    editTodoModal.querySelector("#edit-todo-priority").value =
      todoItem.priority;
    ...
    const formSubmitHandler = (event) => {
      ...
      const todoDescription = form.querySelector(
